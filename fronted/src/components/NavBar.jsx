    ...
    <nav className="sticky top-0 z-50 py-3 backdrop-blur-lg w-full border-b border-opacity-10 border-white bg-navbar-bg hadow-black shadow-md">
      <div className="container mx-auto flex items-center justify-between py-4 sm:py-6 px-4">
        ...
        <div className="flex items-center space-x-4 text-white">
          <Link
            to={navbarlogin[0].link} // ✅ Usa el prop 'to' en lugar de 'href'
            className="bg-sky-700/75 hover:bg-sky-700 theme-light hover:text-gray-100 py-2 px-4 rounded transition-transform hover:scale-110 transform inline-block duration-300 shadow-md shadow-black"
          >
            {navbarlogin[0].title}
          </Link>
      ...
      <div
        className={`md:hidden absolute text-blanco w-full bg-navbar-bg duration-300 transition-all ${
